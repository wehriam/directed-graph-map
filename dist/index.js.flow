 ...
 */
class DirectedGraphMap<S: Stringable, T: Stringable> {
  declare sourceMap:Map<S, Set<T>>;
  declare targetMap:Map<T, Set<S>>;
  declare sourcesCache: Set<S> | void;
  declare targetsCache: Set<T> | void;
  declare edgesCache: Array<[S, T]> | void;
